...
left.file_path = '/home/benjamin/ros/src/metahast/hast/cam_info/';
...
right.host = 'mk3a/ugv1';
right.SERIAL = '17496985';
right.file_path = '/home/benjamin/ros/src/metahast/hast/cam_info/';
...
right.Cx = right.P(1,3);
right.Cy = right.P(2,3);
writeYaml(right);


stereo.Baseline = abs(right.P(1,4));
